 ...
 * discarding below the alpha-test cutoff for BZ_TTA_BLEND_TRANSPARENT
 * layers (cutoff 0.0 for every other blend mode, so this branch is a
 * no-op for them - see warcraft_vert.vert's materialParams doc comment).
