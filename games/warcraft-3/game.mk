...
$(eval $(call test_schema,test-bz-tabletop-audio,,$(TEST_CFLAGS) -Iplatform/bridge,$(BIN_DIR)/test_bz_tabletop_audio$(EXE_EXT),$(WC3_TEST_DIR)/test_bz_tabletop_audio_main.c $(WC3_TEST_DIR)/test_bz_tabletop_audio.c platform/apple/visionos/tabletop/client/s_tabletop_null.c,-lm -lpthread,))
